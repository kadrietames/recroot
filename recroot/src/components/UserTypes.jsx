    ...
    <section className="bg-white py-16 md:py-20 px-6 md:px-10">
      <div className="flex flex-col lg:flex-row gap-8 max-w-6xl mx-auto">
        <div className="bg-secondary rounded-2xl p-6 md:p-10 flex-1 relative overflow-hidden">
          ...
          <h2 className="text-accent text-2xl font-bold mb-2">
            For Candidates
          </h2>
          <p className="text-body text-sm mb-6 max-w-xs pr-12 md:pr-0">
          ...
          <Link
            to="/signup"
            className="bg-accent text-white w-full sm:w-auto justify-center px-6 py-3 rounded-lg text-sm font-medium hover:opacity-90 transition duration-300 cursor-pointer flex items-center gap-2"
          >
            Join as Candidate
            <img
              src={arrow}
        ...
        <div className="bg-blue-50 rounded-2xl p-6 md:p-10 flex-1 relative overflow-hidden">
          ...
          <p className="text-body text-sm mb-6 max-w-[320px] pr-12 md:pr-0">
            Find interviews that match your skills and career goals
          </p>
