    ...
    <DashboardLayout activePage="reports">
      <div className="max-w-5xl mx-auto px-6 pt-1 pb-6 text-left">
        ...
        <div className="w-full mb-5">
          ...
          <div>
            <h1 className="text-[#0f2537] text-2xl font-bold tracking-tight mb-0.5">Generate Report</h1>
        ...
        <div className="flex items-center justify-start gap-2 mb-6 bg-transparent py-1">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <h3 className="text-[#163C6B] font-bold text-xs">AI Analysis</h3>
          </div>
        ...
        <div className="max-w-xl mx-auto bg-transparent border border-slate-200 rounded-2xl p-10 shadow-sm flex flex-col items-center text-center">
          ...
          <p className="text-slate-400 text-[10px] leading-relaxed mb-5">
            Our AI is analyzing your resume and job description <br />
